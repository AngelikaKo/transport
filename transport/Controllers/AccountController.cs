...
namespace transport.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    {                        
                        ...
                        UlicaF = model.UlicaF,
                        KodF = model.KodF,
                        MiastoF = model.MiastoF,
                        TelefonF = model.TelefonF,
                        OCP = model.OCP,
                        AktywnyF = model.AktywnyF
                    }
                    };
        ...
        //
        // GET: /Account/Register/Administrator
        [HttpGet]
        [Authorize(Roles = "Firma")]
        public IActionResult RegisterAdministrator(string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
            return View();
        }
        ...
        [Authorize(Roles = "Firma")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> RegisterAdministrator(RegisterAdministratorViewModel model, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
            {
